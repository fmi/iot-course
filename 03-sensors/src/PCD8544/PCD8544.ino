...
/*
 * Install library Adafruit PCD8544
 * 
 * contrast may need to be changed on line 275 -   display.setContrast(75);
 * also via serial - see line 98++
 * VCC is 3.3V
 * 
 */
...
//Adafruit_PCD8544 display = Adafruit_PCD8544(23, 18, 5, 17,16);
...
Adafruit_PCD8544 display = Adafruit_PCD8544( D8, D0, D6);
